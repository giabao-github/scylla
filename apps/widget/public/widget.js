(function(){var e=`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="white" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <line x1="6" y1="6" x2="18" y2="18"></line>
    ...
    `,l.addEventListener(`click`,P),l.addEventListener(`mouseenter`,k),l.addEventListener(`mouseleave`,A),document.body.appendChild(l),s=document.createElement(`div`),s.id=i,s.tabIndex=-1,s.setAttribute(`role`,`dialog`),s.setAttribute(`aria-label`,`Chat widget`),s.setAttribute(`aria-busy`,`true`),l.setAttribute(`aria-controls`,s.id),s.style.cssText=`
      position: fixed;
      ${g===`bottom-right`?`right: 20px;`:`left: 20px;`}
      bottom: 90px;
      width: 400px;
